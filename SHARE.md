...
Paste a player address and it fetches public on-chain battles from Blockscout/RPC. It shows W/L, opponent, teams, turn count, move count, stable player battle numbers, and a readable turn-by-turn move sequence.
